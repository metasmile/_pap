...
internal class ActionFinalizationTableViewCell: UITableViewCell {
    ...
    private func initialize() {
        ...
        let titleImageViewHeightLayout = titleImageView.heightAnchor.constraint(equalTo: titleImageView.widthAnchor, multiplier: 1)
        titleImageViewHeightLayout.priority = .defaultLow
        titleImageViewHeightLayout.isActive = true
