...
PhotoEditorViewControllerDelegatableApp, ChargeableApp {
    ...
    public static let info = AppInfo(
        ...
        , themeColor: nil, embossIconBundleName: R.image.filtersBAppEmbossIcon.name         , policy: AppPolicy(lifeCycle: AppLifecyclePolicy(instance: .availability), task: AppTaskPolicy.default)
        , minOSVersion: nil
    )
