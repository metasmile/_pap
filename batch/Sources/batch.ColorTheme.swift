...
enum batchColorTheme: Int, Decodable {
    case `default`
    case dark
}

extension batchColorTheme {
...
protocol mmcColorThemeable {
    func _applyTheme(_ colorTheme: batchColorTheme)
...
fileprivate class ColorThemeManager {
    ...
    var colorTheme: batchColorTheme = .dark {
        didSet {
            targets.forEach {
    ...
    func changeTheme(_ theme: batchColorTheme) {
        colorTheme = theme
    }
...
extension mmcColorThemeable where Self: UIViewController {
    ...
    func setColorTheme(_ colorTheme: batchColorTheme, animated: Bool = false) {
...
extension UIView {
    var colorTheme: batchColorTheme {
