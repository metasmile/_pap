...
public class RevertApp: NSObject, KeyPathWatchable, App, FinalizableApp, PersistableApp, AppManagerDelegatableApp, PhotoPickerViewControllerDelegatableApp, PhotoPickerCollectionViewDisplayableApp {
