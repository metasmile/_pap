...
struct StoreKitPayableCenter {
    ...
    static func configure() {
        ...
        Test URL of Sandbox
            ...
            Finder: itms-services://?action=purchaseIntent&bundleId=com.stells.batch&productIdentifier=pap_com.stells.batch.finder_NC_P_owned
            Converter: itms-services://?action=purchaseIntent&bundleId=com.stells.batch&productIdentifier=pap_com.stells.batch.converter_NC_P_owned
            1M: itms-services://?action=purchaseIntent&bundleId=com.stells.batch&productIdentifier=pap_xapp_NR_1M_rented
        */
