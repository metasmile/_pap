...
public class ShopApp: NSObject
    ...
    public static let info = AppInfo(
            identifier: "com.stells.batch.shop"
            , version: "1.0"
            , phase: .release
...
fileprivate class ShopAppDockContent: NSObject, AppDockContent, UITableViewDelegate, UITableViewDataSource, AppLifecycleManagerAllowingInstanceAccessor{
    ...
    private var sections:[Section] {
        ...
        if freeChargeSettingsCellDescribers.count > 0{
            let settings = CellDescriberGroup(label: "Settings for Main Tools License".localized, detailedLabel: "It Displays A Ratio of Remaining Free App Access Periods.".localized, describers: freeChargeSettingsCellDescribers)
            s.append(settings)
        }
