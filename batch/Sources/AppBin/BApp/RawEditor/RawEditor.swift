...
fileprivate class RawEditorDockContent: NSObject, PropertyWatchable, AppDockContent, UITableViewDelegate, UITableViewDataSource{
    ...
    private func rawAttributes() -> [CIFilterAttributes] {
        ...
        return [
            ...
            CIFilterAttributes(key: kCIInputEVKey, attributeType: kCIAttributeTypeScalar, attributes: [CIFilterAttributeItem(name: "EV".localized, attributeKey: kCIInputEVKey, defaultValue: 0, minimumValue: -3, maximumValue: 3)]),
