...
fileprivate class RawEditorDockContent: NSObject, PropertyWatchable, AppDockContent, UITableViewDelegate, UITableViewDataSource{
    ...
    private func rawAttributes() -> [CIFilterAttributes] {
        ...
        return [
            ...
            CIFilterAttributes(key: CIRAWFilterOption.baselineExposure.rawValue, attributeType: kCIAttributeTypeScalar, attributes: [CIFilterAttributeItem(name: "Baseline Exposure".localized, defaultValue: 0, minimumValue: -3, maximumValue: 3)]), // no min max
            CIFilterAttributes(key: kCIInputEVKey, attributeType: kCIAttributeTypeScalar, attributes: [CIFilterAttributeItem(name: "EV", defaultValue: 0, minimumValue: -3, maximumValue: 3)]),
