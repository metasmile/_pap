...
class PreviewCollectionViewCell: CustomCollectionViewCell {
    ...
    func setEditItem(_ item: PHAssetItem<BatchAppValue>, at indexPath: IndexPath) {
    ...
    func setEditItemForPreview(_ item: PHAssetItem<BatchAppValue>, at indexPath: IndexPath) {
        let asset = item.asset
    ...
    func setImageEditItem<T>(_ editItem: StateValueSet<T>, animated: Bool = false) where T: BatchAppValue {
        if animated {
    ...
    private func setAssetInfo<T>(_ asset: PHAsset, editItem: StateValueSet<T>) where T: BatchAppValue {
